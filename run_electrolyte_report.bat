...
REM ============================================
REM  电解液行业分析报告 — 自动化脚本
REM  每月6日由 Windows 任务计划程序触发
REM  生成上一个月的电解液行业分析报告
REM ============================================
echo.
echo ========================================
echo  电解液行业分析报告 - 自动化执行
echo  时间: %date% %time%
echo ========================================
echo.
...
py -3.12 generate_monthly_report.py electrolyte
if %errorlevel% neq 0 (
    echo [ERROR] generate_monthly_report.py 电解液任务执行失败！
    pause
    exit /b 1
)

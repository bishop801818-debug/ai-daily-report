...
FILES = [
    "index_v3.html",
    # 权限闸门脚本（组织架构鉴权：auth_policy.js 须在 inline_auth.js 之前）
    "auth_policy.js", "inline_auth.js", "feishu-jsapi.js", "bu_gate.js",
    # 核心子页面
    ...
    # 报告页面
    "lfp_report_2026_05.html",
    "recycling_report_2026_05.html", "electrolyte_report.html",
    ...
    # 数据文件
    "electrolyte_data.js", "recycling_data_v3.js", "recycling_data_v2.js", "chemical_data.js", "recycling_gantt.js",
    # 回收复活/上游实时面板（与本地 index_v3.html 导航入口同步）
    "recycling_revival.html", "recycling_upstream.html",
...
def main():
    ...
    # 6. 发布到妙搭（生产版 html-publish：app_4k7069448fj88）
    #    注：原 publish_multi_app.py（多应用权限体系）已于 996bf88 撤销，改走单应用直发。
    log("🚀 发布到妙搭生产版（app=app_4k7069448fj88）...")
    r = subprocess.run(f'cd "{BASE}" && lark-cli apps +html-publish --app-id app_4k7069448fj88 --path dist-miaoda',
                       shell=True, capture_output=True, encoding='utf-8', errors='ignore', timeout=1200)
    if r.returncode != 0:
        log(f"❌ 生产版发布失败：{r.stderr[-500:]}")
        return 1
    log("✅ 生产版发布完成 → https://lopal603906.aiforce.cloud/app/app_4k7069448fj88")

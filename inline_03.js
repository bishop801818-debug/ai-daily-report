...
const RADAR_HISTORY = {
    sdmd:{
        ...
        '2026-05':{ dims:{d1:90,d2:90,d3:82,d4:80,d5:90,d6:78},
            kpis:{d1:[94.9,93.5,81.6,100.0], d2:[102.9,85.6,77.0,105.3], d3:[84.1,95.2,71.0,81.6], d4:[72.7,71.4,100.0,null], d5:[108.2,120.0,118.0,50.0], d6:[80.0,80.0,120.0,100.0]} },

        // ── 2026年6月（当月）──
        '2026-06':{ dims:{d1:76,d2:74,d3:78,d4:89,d5:74,d6:100},
            kpis:{d1:[72.3,35.9,93.9,100.0], d2:[63.0,100.0,31.1,100.0], d3:[87.4,100.0,32.3,93.9], d4:[100.0,100.0,null,66.7], d5:[90.0,53.5,53.9,100.0], d6:[100.0,100.0,100.0,100.0]}, _isCurrent:true,
            _kpiComparison:{title:'6月核心KPI达标率（预算 → 实际）',period:'2026年6月',items:[
            ...
            _dimComparison_d2:{title:'6月产品销量达成（预算 → 目标 → 实际）',items:[
            ...
            _dimComparison_d3:{title:'6月生产效率达成（预算 → 目标 → 实际）',items:[
            ...
            _dimComparison_d4:{title:'技术创新力 5月→6月环比',format:'mom',items:[
            ...
            _dimComparison_d5:{title:'安全环保 5月→6月环比',format:'mom',items:[
            ...
            _dimComparison_d6:{title:'组织活力 5月→6月环比',format:'mom',items:[
    ...
    felt:{
        ...
        '2026-06':{
            ...
            kpis:{d1:[52, 67, 33, 100], d2:[52, 67, 65, 96], d3:[62, 84, 59, 96], d4:[116, 86, 100, 54], d5:[100, 100, 100, 100], d6:[0, 50, 50, 0]},
        },
        // ── 2026年4月 ──
        '2026-04':{
    ...
    lubricant:{
        // ── 2026年3月 ──
        '2026-03':{ dims:{d1:100,d2:100,d3:100,d4:100,d5:100,d6:100},
            kpis:{d1:[100.0,100.0,100.0,100.0], d2:[100.0,100.0,100.0,100.0], d3:[100.0,100.0,100.0,100.0], d4:[100.0,100.0,100.0,100.0], d5:[100.0,100.0,100.0,100.0], d6:[100.0,100.0,100.0,100.0]},
            _kpiComparison:{title:'3月核心KPI达标率',period:'2026年3月',items:[
                {name:'销售收入(万)',budget:14758,target:14758,actual:14769,unit:'万元'},
                {name:'净利润(万)',budget:1300,target:1300,actual:1618,unit:'万元'},
                {name:'毛利率(%)',budget:24.3,target:24.3,actual:24.3,unit:'%'},
                {name:'期间费用率(%)',budget:9.79,target:9.79,actual:8.5,unit:'%'},
                {name:'应收账款天数',budget:52,target:52,actual:51,unit:'天'}
            ]},
            _dimComparison_d2:{title:'3月品类销售达成',items:[
                {name:'冷却液(万)',budget:50000,target:4167,actual:10410,unit:'万元'},
                {name:'汽机油(万)',budget:40000,target:3333,actual:9650,unit:'万元'},
                {name:'柴机油(万)',budget:15000,target:1250,actual:4272,unit:'万元'},
                {name:'变速箱油(万)',budget:6000,target:500,actual:1080,unit:'万元'}
            ]},
            _dimComparison_d3:{title:'3月运营效率指标',items:[
                {name:'海外市场(万)',budget:10000,target:833,actual:2045,unit:'万元'},
                {name:'工业油(万)',budget:5000,target:417,actual:67,unit:'万元'},
                {name:'玻璃水(万)',budget:7000,target:583,actual:380,unit:'万元'},
                {name:'应收账款天数',budget:52,target:52,actual:51,unit:'天'}
            ]},
        },
        // ── 2026年4月 ──
        '2026-04':{ dims:{d1:96,d2:100,d3:100,d4:94,d5:75,d6:100},
            kpis:{d1:[100.0,90.0,94.0,100.0], d2:[100.0,100.0,100.0,100.0], d3:[100.0,100.0,100.0,100.0], d4:[100.0,100.0,100.0,75.0], d5:[100.0,100.0,100.0,0.0], d6:[100.0,100.0,100.0,100.0]},
            _kpiComparison:{title:'4月核心KPI达标率',period:'2026年4月',items:[
                {name:'销售收入(万)',budget:8530,target:8530,actual:11881,unit:'万元'},
                {name:'净利润(万)',budget:1125,target:1125,actual:1007,unit:'万元'},
                {name:'毛利率(%)',budget:24.3,target:24.3,actual:22.8,unit:'%'},
                {name:'期间费用率(%)',budget:13.67,target:13.67,actual:12.0,unit:'%'},
                {name:'应收账款天数',budget:52,target:52,actual:51,unit:'天'}
            ]},
            _dimComparison_d2:{title:'4月品类销售达成',items:[
                {name:'冷却液(万)',budget:50000,target:4167,actual:14431,unit:'万元'},
                {name:'汽机油(万)',budget:40000,target:3333,actual:14854,unit:'万元'},
                {name:'柴机油(万)',budget:15000,target:1250,actual:5902,unit:'万元'},
                {name:'变速箱油(万)',budget:6000,target:500,actual:1630,unit:'万元'}
            ]},
            _dimComparison_d3:{title:'4月运营效率指标',items:[
                {name:'海外市场(万)',budget:10000,target:833,actual:2613,unit:'万元'},
                {name:'工业油(万)',budget:5000,target:417,actual:67,unit:'万元'},
                {name:'玻璃水(万)',budget:7000,target:583,actual:585,unit:'万元'},
                {name:'应收账款天数',budget:52,target:52,actual:51,unit:'天'}
            ]},
        },
        // ── 2026年5月 ──
        '2026-05':{ dims:{d1:98,d2:98,d3:83,d4:85,d5:80,d6:98},
            kpis:{d1:[10.0,9.79,9.3,10.0], d2:[10.0,9.79,9.3,10.0], d3:[10.0,3.19,10.0,10.0], d4:[10.0,10.0,8.0,6.0], d5:[10.0,10.0,7.0,5.0], d6:[8.0,5.0,7.0,6.0]},
            _isCurrent:true,
            _kpiComparison:{title:'5月核心KPI达标率',period:'2026年5月',items:[
                {name:'销售收入(万)',budget:10865,target:10865,actual:11123,unit:'万元'},
                {name:'净利润(万)',budget:1109,target:1109,actual:1086,unit:'万元'},
                {name:'毛利率(%)',budget:24.3,target:24.3,actual:22.6,unit:'%'},
                {name:'期间费用率(%)',budget:11.08,target:11.08,actual:9.8,unit:'%'},
                {name:'应收账款天数',budget:52,target:52,actual:50,unit:'天'}
            ]},
            _dimComparison_d2:{title:'5月品类销售达成',items:[
                {name:'冷却液(万)',budget:50000,target:4167,actual:19591,unit:'万元'},
                {name:'汽机油(万)',budget:40000,target:3333,actual:17816,unit:'万元'},
                {name:'柴机油(万)',budget:15000,target:1250,actual:6527,unit:'万元'},
                {name:'变速箱油(万)',budget:6000,target:500,actual:1994,unit:'万元'}
            ]},
            _dimComparison_d3:{title:'5月运营效率指标',items:[
                {name:'海外市场(万)',budget:10000,target:833,actual:4015,unit:'万元'},
                {name:'工业油(万)',budget:5000,target:417,actual:133,unit:'万元'},
                {name:'玻璃水(万)',budget:7000,target:583,actual:788,unit:'万元'},
                {name:'应收账款天数',budget:52,target:52,actual:50,unit:'天'}
            ]},
            _dimComparison_d4:{title:'5月技术创新力 4月→5月环比',format:'mom',items:[
                {name:'新产品销量(吨)',prev:580,curr:615,unit:'吨'},
                {name:'采购降本(万)',prev:168.91,curr:678.23,unit:'万元'},
                {name:'技术服务项目(个)',prev:0,curr:4,unit:'个'},
                {name:'OEM认证(项)',prev:0,curr:1,unit:'项'}
            ]},
            _dimComparison_d5:{title:'5月风险合规 4月→5月环比',format:'mom',items:[
                {name:'采购及时到货率(%)',prev:92,curr:98,unit:'%'},
                {name:'客户审核通过(家)',prev:1,curr:3,unit:'家'},
                {name:'质量体系认证推进',prev:0,curr:1,unit:'项'},
                {name:'供应商渠道问题(个)',prev:0,curr:1,unit:'个'}
            ]},
            _dimComparison_d6:{title:'5月组织活力 4月→5月环比',format:'mom',items:[
                {name:'新客户开发(家)',prev:0,curr:10,unit:'家'},
                {name:'AI项目立项(项)',prev:0,curr:0,unit:'项'},
                {name:'海外客户开发(家)',prev:0,curr:2,unit:'家'},
                {name:'数字化项目(个)',prev:0,curr:1,unit:'个'}
            ]},
        },
        // ── 2026年6月（当月）──
        '2026-06':{ dims:{d1:81,d2:100,d3:92,d4:90,d5:100,d6:85},
    ...
    dhx:{
        ...
        '2026-05':{
            ...
            kpis:{d1:[80, 77, 96, 100], d2:[75, 81, 87, 67], d3:[90, 83, 100, 90], d4:[80, 95, 60, 83], d5:[100, 100, 85, 100], d6:[80, 80, 75, 75]},
        },
        // ── 2026年6月（当月）──
        '2026-06':{
    ...
    lpsd:{
        // ── 2026年3月（Q1季度报告）──
        '2026-03':{
            dims:{d1:68,d2:70,d3:78,d4:82,d5:68,d6:75},
            kpis:{d1:[60, 85, 100, 100], d2:[53, 100, 85, 85], d3:[91, 82, 91, 83], d4:[85, 85, 90, 85], d5:[70, 55, 100, 100], d6:[85, 80, 90, 50]},
        },
        // ── 2026年4月 ──
        '2026-04':{
